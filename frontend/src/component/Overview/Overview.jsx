...
import eventImage from "../../assets/marcela-laskoski-YrtFlrLo2DQ-unsplash.jpg"; // Make sure this path is correct
      ...
      <div className="container">
        ...
        <div className="overview-grid">
          <div className="overview-content">
            <p>
              <b>The Maharashtra Education Icon Awards</b> is a prestigious
              ceremony that recognizes and honors outstanding contributions to
              the field of education across Maharashtra. This annual event
              brings together educators, administrators, policymakers, and
              innovators who have made significant impacts in shaping the future
          ...
          <div className="overview-image">
            <img src={eventImage} alt="Maharashtra Education Icon Awards" />
          </div>
        </div>
      </div>
    </section>
