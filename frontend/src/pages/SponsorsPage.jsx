...
const SponsorsPage = () => {
  ...
  const handleEmailClick = () => {
    window.location.href = "mailto:gaurav@jobizza.com?subject=Sponsorship Inquiry - Maharashtra Education Icon Awards";
  };
      ...
      <div className="container">
        ...
        <div className="sponsorship-tiers">
            ...
            <table className="sponsorship-table">
              ...
              <tbody>
                <tr className="platinum-tier">
                  ...
                  <td className="investment-cell"><FaRupeeSign className="rupee-icon" /> 20 Lakhs</td>
                </tr>
                <tr className="gold-tier">
                  ...
                  <td>01</td>
                  <td>Full Page Color (inside)</td>
                  <td className="investment-cell"><FaRupeeSign className="rupee-icon" /> 15 Lakhs</td>
                </tr>
                <tr className="silver-tier">
                  ...
                  <td>01</td>
                  <td>Full Page Color (inside)</td>
                  <td className="investment-cell"><FaRupeeSign className="rupee-icon" /> 10 Lakhs</td>
                </tr>
                <tr>
                  ...
                  <td>01</td>
                  <td>Full Page B/W</td>
                  <td className="investment-cell"><FaRupeeSign className="rupee-icon" /> 7 Lakhs</td>
                </tr>
                <tr>
                  <td>Kit Sponsor</td>
                  <td><FaCheck className="icon-check" /></td>
                  ...
                  <td>01</td>
                  <td>Full Page B/W</td>
                  <td className="investment-cell"><FaRupeeSign className="rupee-icon" /> 5 Lakhs</td>
                </tr>
                <tr>
                  ...
                  <td>01</td>
                  <td>Full Page B/W</td>
                  <td className="investment-cell"><FaRupeeSign className="rupee-icon" /> 3 Lakhs</td>
                </tr>
          ...
          <div className="other-sponsorships">
            <h3>Other Sponsorships (<FaRupeeSign className="rupee-icon" /> 2 Lakhs Each)</h3>
        ...
        <div className="contact-actions">
          <button onClick={handleSponsorClick} className="btn btn-sponsor">
            Become a Sponsor
            {showContactOptions ? <FaChevronUp className="chevron-icon" /> : <FaChevronDown className="chevron-icon" />}
          </button>
              ...
              <div className="contact-content">
                {activeTab === 'email' ? (
                  <div className="email-content">
                    ...
                    <button onClick={handleEmailClick} className="btn btn-contact">
                      Email Gaurav Sharma
                    </button>
                  </div>
                ) : (
                  <div className="phone-content">
                    ...
                    <button onClick={handlePhoneClick} className="btn btn-contact">
                      Call Now: 8888181889
                    </button>
                  </div>
                )}
